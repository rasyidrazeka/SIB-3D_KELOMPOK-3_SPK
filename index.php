        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary rounded p-4">
                    <div class="d-flex align-items-center justify-content-start text-center mb-4">
                        <h1 class="mb-3 mt-2" style="color: red;">Apa itu Metode Topsis</h1>
                    </div>
                    <div class="d-flex align-items-center justify-content-center mb-4">
                        <span class="mb-0" style="color: white;">SPK adalah sebuah sistem berbasis komputer dengan antarmuka antara mesin/komputer dan pengguna. SPK ditujukan untuk membantu pembuat keputusan dalam menyelesaikan suatu masalah dalam berbagai level manajemen dan bukan untuk mengganti posisi manusia sebagai pembuat keputusan. SPK mampu memberi alternatif solusi bagi masalah semi/tidak terstruktur baik bagi perseorangan atau kelompok dan dalam berbagai macam proses dan gaya pengambilan keputusan.</span>
                    </div>
                    <div class="d-flex align-items-center justify-content-center mb-4">
                        <span class="mb-0" style="color: white;">TOPSIS (Techinique for Order Preference by Similarity to Ideal Solution) didasarkan pada konsep dimana alternatif terpilih yang terbaik tidak hanya memiliki jarak terpendek dari solusi ideal positif, namun juga memiliki jarak terpanjang dari solusi ideal negatif. Metode TOPSIS adalah salah satu metode yang digunakan untuk menyelesaikan masalah MADM. Metode TOPSIS didasarkan pada konsep dimana alternatif terpilih yang terbaik tidak hanya memiliki jarak terpendek dari solusi ideal positif, namun juga memiliki jarak terpanjang dari solusi ideal negatif. Konsep ini banyak digunakan pada beberapa model MADM untuk menyelesaikan masalah keputusan secara praktis.</span>
                    </div>
                </div>
            </div>
            <!-- Recent Sales End -->
