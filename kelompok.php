        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="" class="nav-item nav-link"><i class="bi bi-person me-2"></i>Anggota</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary rounded p-4">
                    <div class="d-flex align-items-center justify-content-start text-center mb-4">
                        <h1 class="mb-3 mt-2" style="color: red;">Anggota Kelompok 3</h1>
                    </div>
                    <div class="d-flex align-items-center justify-content-center text-center mb-4">
                        <div class="container-fluid card-group mt-3">
                            <div class="card">
                                <div class="d-flex flex-column card-body bg-secondary rounded">
                                    <h5 class="card-title my-3">Ashraf Nawaf</h5>
                                    <p class="card-text">SIB3D</p>
                                    <p class="card-text mb-3">02</p>
                                </div>
                            </div>
                            <div class="card">
                                <div class="d-flex flex-column card-body bg-secondary rounded">
                                    <h5 class="card-title my-3">Fauzan Zulfa Ramadhan</h5>
                                    <p class="card-text">SIB3D</p>
                                    <p class="card-text mb-3">08</p>
                                </div>
                            </div>
                            <div class="card">
                                <div class="d-flex flex-column card-body bg-secondary rounded">
                                    <h5 class="card-title my-3">Maulana Akbar</h5>
                                    <p class="card-text">SIB3D</p>
                                    <p class="card-text mb-3">12</p>
                                </div>
                            </div>
                            <div class="card">
                                <div class="d-flex flex-column card-body bg-secondary rounded">
                                    <h5 class="card-title my-3">Rasyid Razeka Alamsyah</h5>
                                    <p class="card-text">SIB3D</p>
                                    <p class="card-text mb-3">15</p>
                                </div>
                            </div>
                        </div>
                    </div>
