                                    ...
                                    <div class="">
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            <ul class="nav nav-tabs">
                                                <li>
                                                    <a class="btn btn-primary mb-3 me-3" type="button" href="alternatiftambah.php" data-toggle="tab">Tambah Alternatif</a>
                                                </li>
                                                <li>
                                                    <a class="btn btn-primary mb-3" type="button" href="hapusseluruhalternatif.php" data-toggle="tab">Hapus Seluruh Data</a>
                                                </li>
                                            </ul>
                                            <thead>
                                                <tr>
